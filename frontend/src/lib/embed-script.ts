...
(function() {
  ...
  var BOT_ID = '${botId}';
  var PRIMARY_COLOR = '${color || "#0f172a"}';
  var APP_URL = '${appUrl}';
  ...
  style.textContent = [
    '#chatbot-toggle{position:fixed;bottom:24px;right:24px;width:56px;height:56px;border-radius:50%;background:' + PRIMARY_COLOR + ';border:none;cursor:pointer;box-shadow:0 4px 16px rgba(0,0,0,0.25);z-index:999998;display:flex;align-items:center;justify-content:center;transition:transform 0.2s;}',
